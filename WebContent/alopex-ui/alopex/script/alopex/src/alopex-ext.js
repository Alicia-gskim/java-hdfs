      ...
      if(numChecked === 0) {
        ...
        if($.isFunction(o.selectedText)) {
          value = o.selectedText.call(this, numChecked, $inputs.length, $checked.get());
        	...
        	//2016-12-06: .html을 사용해서 특수문자가 깨지는 현상에 대한 option처리.(https://nexcore.skcc.com/support/issues/3377) 이 경우 span에 <b>test</b> 와 같은 형태를 bind할 수 없음.
        	if(o.htmlBind){
    ...
    updateCache: function() {
      ...
      this.cache = this.element.children().map(function() {
        ...
        return elem.map(function() {
        		var innerData = null;
        		if(this && this.nodeName === 'OPTION'){
        			innerData = this.innerText;
        		}else{
        			innerData = this.innerHTML;
        		}
          return innerData.toLowerCase();
        }).get();
      }).get();
    },
...
//                    $(dragDrop).append(uploadLabel);
	   ...
	   this.startUpload = function () {
        ...
        this.createProgress = function (filename,filepath,filesize) {
        	var fileInfo = {name:filename,path:filepath,size:filesize}
            ...
            if(s.showDownload) {
                ...
                pd.download.click(function () {
                    ...
                    if(s.downloadCallback) s.downloadCallback.call(obj,fileInfo,pd);
                });
            }
            if(s.showDelete)
            {
    	        ...
    	        pd.del.click(function () {
            	    ...
            	    //일관된 파일명 접근을 위해 통일.
                	if(s.deleteCallback) s.deleteCallback.call(this, fileInfo, pd);
	                obj.selectedFiles -= 1;
